  ...
  return (
    <PageTransition>
      <main className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-stack-lg">
        <nav aria-label="مسار التنقل" className="animate-fade-up flex items-center gap-2 mb-stack-lg text-body-sm font-body-sm text-on-surface-variant">
          <Link
            to="/"
        ...
        <header className="mb-stack-lg">
          ...
          <p
            className="animate-fade-up max-w-readable text-body-base font-body-base text-on-surface-variant"
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-gutter">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <div
                key={i}
                className="animate-fade-in bg-surface-container-lowest dark:bg-surface-container-lowest-dark rounded-xl shadow-ambient aspect-[4/5] overflow-hidden"
