          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter">
            ...
            >
              ...
              <div>
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant dark:text-inverse-on-surface/80">{CONTACT_INFO.addressAr}</p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div>
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant dark:text-inverse-on-surface/80">{CONTACT_INFO.hoursAr}</p>
              </div>
            </motion.div>
            <motion.div
              className="bg-surface-container-lowest dark:bg-surface-container-lowest-dark rounded-xl p-stack-md shadow-ambient border border-primary/10 flex items-start space-x-reverse space-x-stack-sm"
            ...
            >
              ...
              <div>
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant dark:text-inverse-on-surface/80">{CONTACT_INFO.phone}</p>
              </div>
            </motion.div>
          </div>
        </section>
